...
function placeXOrO(squareNumber) {
    ...
    if(!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer ==='X') {
            ...
            select.style.backgroundImage = 'url("./images/rebel_jedi.png")';
        }
...
function checkWinConditions() {
    ...
    //This condition checks for tie. If non of the abover conditions register and 
        //9 squares are selected, the code executes.
    else if(selectedSquares.length>=9) {
        //This function plays the tie game sound.
        audio("./media/use_the_force.mp3");
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variables we pass are all included in our array true is 
            //returned and our else if condition executes in the drawWinLine 
            //function.
...
//This function interacts with the canvas
    function animateLineDrawing() {
        ...
        //This method c,lears content from last loop iteration.
